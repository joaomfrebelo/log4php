...
abstract class LoggerFilter extends LoggerConfigurable
{
    ...
    /**
     * @var LoggerFilter|null Points to the next {@link LoggerFilter} in the filter chain.
     */
     ...
     * @return LoggerFilter|null next filter
     */
    public function getNext(): ?LoggerFilter
    {
        return $this->next;
    }
