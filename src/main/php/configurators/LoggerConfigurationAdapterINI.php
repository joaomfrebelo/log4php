...
class LoggerConfigurationAdapterINI implements LoggerConfigurationAdapter
{
     ...
     */
    private function parseLogger(string $value, string $name)
    {
    ...
    /**
     * Parses a configuration line pertaining to an appender.
     *
     ...
     * @param string $value
     */
    private function parseAppender(string $key, string $value)
    {
     ...
     */
    private function parseRenderer(string $key, string $value)
    {
        // Remove the appender prefix from key
