...
class LoggerLayoutPattern extends LoggerLayout
{
    ...
    protected string|array $pattern = self::DEFAULT_CONVERSION_PATTERN;
     ...
     * @param string|array $conversionPattern
     */
    public function setConversionPattern(string|array $conversionPattern)
    {
