...
class LoggerLayoutXml extends LoggerLayout
{
    ...
    const LOG4J_NS = 'https://jakarta.apache.org/log4j/';

    const LOG4PHP_NS_PREFIX = 'log4php';
    const LOG4PHP_NS = 'https://logging.apache.org/log4php/';
    ...
    /**
     * Whether file name and line number will be included in the output.
     * @return boolean
     */
     ...
     * @param boolean $flag
     */
    public function setLog4jNamespace(bool $flag)
    {
