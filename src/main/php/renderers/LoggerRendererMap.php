...
class LoggerRendererMap
{
     ...
     * @var LoggerRenderer
     */
    private LoggerRenderer $defaultRenderer;
     ...
     *
     * @param mixed $object
     * @return LoggerRenderer|null if none found.
     */
     ...
     *
     * @param string $class
     * @return LoggerRenderer|null if not found.
     */
    ...
    /** Resets the renderer map to its default configuration. */
