...
class LoggerRootTest extends TestCase
{
    ...
    /**
     * log4php: LoggerRoot cannot have a parent.
     */
    public function testSetParentWarning()
    {
        $this->expectError();
        $this->expectErrorMessage("log4php: LoggerRoot cannot have a parent.");
        $root   = new LoggerRoot();
    ...
    /**
     * log4php: Cannot set LoggerRoot level to null.
     */
    public function testNullLevelWarning()
    {
        $this->expectError();
        $this->expectErrorMessage("log4php: Cannot set LoggerRoot level to null.");
        $root = new LoggerRoot();
        $root->setLevel(null);
    }
}
