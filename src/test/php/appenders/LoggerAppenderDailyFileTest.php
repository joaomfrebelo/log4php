...
class LoggerAppenderDailyFileTest extends TestCase
{
    ...
    {
        $this->expectWarning();
        $this->expectWarningMessage("Required parameter 'file' not set.");
        $appender = new LoggerAppenderDailyFile();
        $appender->activateOptions();
    }

    /**
     * Required parameter 'datePattern' not set.
     */
    public function testRequiredParamWarning2()
    {
        $this->expectWarning();
        $this->expectWarningMessage("Required parameter 'datePattern' not set.");
        $appender = new LoggerAppenderDailyFile();
    ...
    public function testRequiredParamWarning3()
    {
        ...
        $appender->setDatePattern('');
        @$appender->activateOptions();
        $this->assertInstanceOf(LoggerAppenderDailyFile::class, $appender);
    }
    ...
    public function testLazyFileOpen()
    {
        ...
        $date = date($pattern, (int)$event->getTimeStamp());
