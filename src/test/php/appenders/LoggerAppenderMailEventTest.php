 ...
 * @group appenders
 */
class LoggerAppenderMailEventTest extends TestCase
{
     ...
     * Required parameter 'to' not set.
     */
    public function testEmptyTo()
    {
        $this->expectWarning();
        $this->expectWarningMessage("Required parameter 'to' not set.");
        $appender = new LoggerAppenderMailEvent("myname");
     ...
     * Required parameter 'from' not set.
     */
    public function testEmptyFrom()
    {
        $this->expectWarning();
        $this->expectWarningMessage("Required parameter 'from' not set.");
        $appender = new LoggerAppenderMailEvent("myname");
        $appender->setLayout(new LoggerLayoutSimple());
