...
function errorHandler($errno, $errstr): void
{
    TestCase::assertEquals(LoggerAppenderPhpTest::$expectedError, $errno);
    TestCase::assertEquals(LoggerAppenderPhpTest::$expectedMessage, $errstr);
}
...
class LoggerAppenderPhpTest extends TestCase
{
    ...
    public static int $expectedError;
