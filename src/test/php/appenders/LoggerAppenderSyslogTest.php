...
class LoggerAppenderSyslogTest extends TestCase
{
    ...
    public function testLogging()
    {
        ...
        $this->assertInstanceOf(LoggerAppenderSyslog::class, $appender);
    }
    ...
    public function testFacility()
    {
        ...
        $appender = new LoggerAppenderSyslog();
        $appender->activateOptions();
        $value = $property->getValue($appender);
    ...
    {
        $this->expectWarning();
        $this->expectWarningMessage("log4php: Invalid syslog option provided: XYZ. Whole option string: CONS|XYZ");
        $appender = new LoggerAppenderSyslog();
    ...
    {
        $this->expectWarning();
        $this->expectWarningMessage("log4php: Invalid syslog priority provided: XYZ.");
        $appender = new LoggerAppenderSyslog();
    ...
    {
        $this->expectWarning();
        $this->expectWarningMessage("log4php: Invalid syslog facility provided: XYZ.");
        $appender = new LoggerAppenderSyslog();
