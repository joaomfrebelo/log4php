 ...
 * @group configurators
 */
class LoggerConfigurationAdapterINITest extends \PHPUnit\Framework\TestCase
{
     ...
     * File [you/will/never/find/me.ini] does not exist.
     */
    ...
    {
        $this->expectException(LoggerException::class);
        $this->expectExceptionMessageMatches("/Error parsing configuration file/");
     ...
     * log4php: Don't know how to parse the following line: "log4php.appender.default.layout.param.bla = LoggerLayoutTTCC". Skipping.
     */
    public function testInvalidLineWarning1()
    {
        $this->expectNotice(LoggerException::class);
        $this->expectNotice("/Don't know how to parse the following line/");
    ...
    /**
     * Test a warning is triggered when configurator doesn't understand a line.
     * log4php: Don't know how to parse the following line: "log4php.appender.default.not-layout.param = LoggerLayoutTTCC". Skipping.
     */
