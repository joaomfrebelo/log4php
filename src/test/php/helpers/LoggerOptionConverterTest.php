...
const MY_CONSTANT_CONSTANT       = 'DEFINE';
const MY_CONSTANT_CONSTANT_OTHER = 'DEFINE_OTHER';
...
class LoggerOptionConverterTest extends TestCase
{
    ...
    /**
     * Test fail on NULL.
     * Given value [NULL] cannot be converted to boolean.
     */
     ...
     * Given value ['foo'] cannot be converted to boolean.
     */
    ...
    /**
     * Test fail on NULL.
     * Given value [NULL] cannot be converted to integer.
     */
    ...
    /**
     * Test fail on invalid string.
     * Given value ['foo'] cannot be converted to integer.
     */
     ...
     * Given value [true] cannot be converted to integer.
     */
    ...
    /**
     * Test fail on boolean.
     * Given value [false] cannot be converted to integer.
     */
