...
class FruitRenderer3 implements LoggerRenderer
{
    public function render(mixed $input): string
    {
        return $input->test1 . ',' . $input->test2 . ',' . $input->test3;
    }
}
...
class LoggerRendererMapTest extends TestCase
{
     ...
     * Failed adding renderer. Rendering class [DoesNotExist] not found.
     */
    public function testAddRendererError1()
    {
        $this->expectNotice();
        $this->expectNoticeMessage("Failed adding renderer. Rendering class [DoesNotExist] not found.");
        $map = new LoggerRendererMap();
     ...
     * Failed setting default renderer. Rendering class [DoesNotExist] not found.
     */
    public function testSetDefaultRendererError1()
    {
        $this->expectNotice();
        $this->expectNoticeMessage("Failed setting default renderer. Rendering class [DoesNotExist] not found.");
        $map = new LoggerRendererMap();
     ...
     * Failed setting default renderer. Rendering class [stdClass] does not implement the LoggerRenderer interface.
     */
    public function testSetDefaultRendererError2()
    {
        $this->expectNotice();
        $this->expectNoticeMessage("Failed setting default renderer. Rendering class [stdClass] does not implement the LoggerRenderer interface.");
        $map = new LoggerRendererMap();
